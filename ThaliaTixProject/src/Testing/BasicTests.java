...
import thaliatix.BoundaryInterfaceDonation;
import thaliatix.BoundaryInterfaceOrder;
import thaliatix.BoundaryInterfaceSeating;
import thaliatix.BoundaryInterfaceShow;
import thaliatix.BoundaryInterfaceTicket;
import thaliatix.DisplayOrder;
import thaliatix.Donation;
import thaliatix.DonationManager;
import thaliatix.NullShow;
import thaliatix.Order;
import thaliatix.OrderManager;
import thaliatix.OrderNull;
import thaliatix.OrderReducedInfo;
import thaliatix.PatronInfo;
import thaliatix.ReducedTicketInfo;
import thaliatix.Report;
import thaliatix.Seat;
import thaliatix.SeatNull;
import thaliatix.SeatRequest;
import thaliatix.Seating;
import thaliatix.SeatingInfo;
import thaliatix.SeatingManager;
import thaliatix.Section;
import thaliatix.SectionDetail;
import thaliatix.SectionInfo;
import thaliatix.Show;
import thaliatix.ShowDetail;
import thaliatix.ShowInfo;
import thaliatix.ShowManager;
import thaliatix.ShowSectionDetailedInfo;
import thaliatix.SpecificShowDetail;
import thaliatix.SpecificShowDetailNull;
import thaliatix.Ticket;
import thaliatix.TicketManager;

class BasicTests {

	private static BoundaryInterfaceShow showManager = new ShowManager();
	private static BoundaryInterfaceSeating seatingManager = new SeatingManager();
